...
import { ClearingIllustration } from "@/components/illustrations";

const steps = [
  {
    number: "01",
    title: "Completás tus datos",
    desc: "Nos indicás por qué quieres empezar terapia y tus datos de contacto.",
  },
  {
    number: "02",
  ...
  {
    number: "03",
    title: "Agendás tu sesión",
    desc: "Coordinamos día, horario y te enviamos los detalles para conectarte.",
  },
];
...
const benefits = [
  ...
  },
  {
    ...
    desc: "Nuestro equipo te acompaña en cada etapa, resolviendo dudas y brindando recursos.",
  },
  {
    icon: Shield,
    title: "Psicologos especializados",
    desc: "Contamos con profesionales formados en distintas áreas y amplia trayectoria.",
  },
];
...
const team = [
  ...
  { name: "Dra. Malen D.", specialty: "Psicoanálisis" },
  ...
  return (
    <div className="wati-page-shell flex flex-col">
        ...
        <Container>
          <FadeIn className="max-w-2xl mx-auto text-center relative z-10">
            ...
            <div className="mx-auto mt-10 max-w-md overflow-hidden rounded-[2rem] border border-border bg-card p-3 shadow-soft">
              <ClearingIllustration className="rounded-[1.5rem]" />
            </div>
          </FadeIn>
        </Container>
      </section>
      ...
      <Section id="precios" spacing="lg" background="muted">
        <Container>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <FadeIn>
              <Heading level="h2" className="mb-8"><em>Comenzá tu proceso de terapia.</em></Heading>
              <div className="space-y-4 text-foreground">
                <div className="flex items-center gap-3"><Check className="h-5 w-5 text-accent flex-shrink-0" /><span>Duración de 45 a 60 minutos</span></div>
                <div className="flex items-center gap-3"><Check className="h-5 w-5 text-accent flex-shrink-0" /><span>Pago seguro con tarjeta de crédito/débito</span></div>
                <div className="flex items-center gap-3"><Check className="h-5 w-5 text-accent flex-shrink-0" /><span>100% online, desde donde estés</span></div>
            ...
            <StaggerContainer className="space-y-6">
              <FadeIn>
                <Card className="bg-background border-none shadow-soft p-6 md:p-8 relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-heading font-semibold text-foreground mb-2">Pack de 4 sesiónes</h3>
                  <p className="text-sm text-muted-foreground mb-4">Reserva 4 sesiónes a traves de un unico pago con descuento.</p>
      ...
      <Section spacing="lg">
        <Container>
          <FadeIn className="text-center mb-16">
            ...
            <Text variant="lead" className="max-w-lg mx-auto">
              Trabajamos con un equipo de profesionales clínicos para que encuentres a alguien con quien te sientas a gusto.
            </Text>
          </FadeIn>
      ...
      <Section spacing="lg" background="muted">
        <Container size="sm">
          <FadeIn className="text-center">
            <Heading level="h2" className="mb-4">Más de 1.500 personas nos eligen para acompañarlas en su proceso.</Heading>
            <Text variant="lead" className="max-w-lg mx-auto mb-8">
              Invertir en tu bienestar emocional es la decision más importante que puedes tomar hoy.
            </Text>
            <Button
              size="lg"
              variant="secondary"
