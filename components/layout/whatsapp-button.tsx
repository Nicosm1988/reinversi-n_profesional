...
export async function WhatsappButton({ locale }: { locale: string }) {
  ...
  const href = `https://wa.me/${digits}?text=${encodeURIComponent(t("message"))}`;
  ...
  return (
    <a
      ...
      className="fixed right-5 z-[65] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_18px_40px_-16px_rgba(0,0,0,.5)] transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#25D366]"
