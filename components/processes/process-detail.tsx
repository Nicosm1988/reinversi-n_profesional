...
export function ProcessDetail({ process }: { process: SendaProcess }) {
  ...
  return (
    <article className={`senda-process-detail senda-process-detail--${process.accent} bg-[var(--senda-bg)] text-[var(--senda-ink)]`}>
      <header className="senda-night border-b border-white/10 px-5 pb-24 pt-36 text-[#f4efe4] sm:px-8 md:pb-32 md:pt-44 lg:px-12 xl:px-20">
        <UniverseField className="left-[34%] text-[#89a9bd] opacity-25" />
      ...
      <section className="px-5 py-24 sm:px-8 md:py-36 lg:px-12 xl:px-20">
        <div className="senda-editorial-card senda-reveal mx-auto grid max-w-[1100px] gap-12 rounded-[1.35rem] p-7 sm:p-12 lg:grid-cols-[0.7fr_1fr] lg:p-16">
          <div>
      ...
      <section className="px-5 pb-10 sm:px-8 lg:px-12 xl:px-20">
        <div className="senda-night relative mx-auto overflow-hidden rounded-[1.4rem] border border-white/10 px-7 py-16 text-[#f4efe4] sm:px-12 md:py-24 lg:px-20">
