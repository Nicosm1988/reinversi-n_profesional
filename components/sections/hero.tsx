                ...
                <StaggerContainer>
                    ...
                    <SlideUp delay={0.1}>
                        <Heading level="h1" className="mb-6 max-w-4xl mx-auto">
                            ...
                            Estás en <span className="italic font-serif text-secondary">transición estratégica</span>.
                        </Heading>
                    </SlideUp>
                    ...
                    <SlideUp delay={0.2}>
                        <Text variant="lead" className="max-w-2xl mx-auto mb-10">
                            ...
                            La primera plataforma híbrida que combina inteligencia artificial y criterio experto.
                        </Text>
                    </SlideUp>
