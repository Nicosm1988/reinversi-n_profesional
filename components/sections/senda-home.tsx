        ...
        <div className="relative mx-auto grid w-full max-w-[1240px] gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-16">
          <div className="max-w-3xl">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              <Link href="/recorridos" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-white/30 bg-white/[0.04] px-7 py-3 text-sm font-bold text-[#f5f1e8] backdrop-blur-sm transition-colors hover:border-white/55 hover:bg-white/[0.09] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white">
      ...
      <section className="px-5 pb-10 sm:px-8 lg:px-12 xl:px-20">
        <div className="senda-night relative mx-auto max-w-[1180px] overflow-hidden rounded-[1.5rem] border border-white/10 px-7 py-14 text-[#f5f1e8] sm:px-12 sm:py-16 lg:px-16 lg:py-20">
          ...
          <div className="relative max-w-3xl">
            ...
            <Link href="/contacto" className="mt-8 inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#f4efe4] px-7 py-3 text-sm font-bold text-[#17263a] transition-colors hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white">
