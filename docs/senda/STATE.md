...
**Última verificación:** 2026-08-24, desde el proyecto `original` (`v0-reinvention-web-platform`).
...
- Anclas solicita antes de comenzar un consentimiento obligatorio, expreso e informado para enviar a `hola@universosenda.com` y `tanisardella@gmail.com` la dirección de correo de la cuenta Google, el momento profesional opcional, el ranking completo, los puntajes y la devolución orientativa determinística persistida. El informe excluye identificadores técnicos, fecha exacta y las 40 respuestas individuales, y no habilita marketing; la interpretación por IA permanece separada y no es una dependencia de ese envío. El formulario SMTP posterior queda reservado para pedir contacto de manera opcional. El endpoint legado `diagnostics/save` permanece retirado (410).
